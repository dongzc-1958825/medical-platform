// src/pages/mobile/MobileCasesPage.tsx - 修复版
...
'@ | Out-File -FilePath "src/pages/mobile/MobileCasesPage.tsx" -Encoding UTF8

Write-Host "✅ 已创建简化版本，移除了图标库依赖" -ForegroundColor Green